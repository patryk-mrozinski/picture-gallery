  ...
  return (
    <div>
      <Menu as="div" className="relative inline-block text-center">
        <div>
          <MenuButton className="inline-flex w-full justify-center rounded-md bg-white px-6 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
            <span
